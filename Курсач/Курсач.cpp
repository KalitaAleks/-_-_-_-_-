//  урсач.cpp:; главный файл проекта.
...
HANDLE hFile=CreateFile(L"D:\\проги\\ урсачќ—\\ урсач\\шахматы1.txt",GENERIC_READ, FILE_SHARE_READ,NULL,OPEN_EXISTING,FILE_ATTRIBUTE_NORMAL,NULL);                 
DWORD r;
...
DWORD WINAPI THREATE1(void* arg){
	WaitForSingleObject(n,INFINITE);
HANDLE hFile=CreateFile(L"D:\\проги\\ урсачќ—\\ урсач\\шахматы2.txt",GENERIC_READ, FILE_SHARE_READ,NULL,OPEN_EXISTING,FILE_ATTRIBUTE_NORMAL,NULL);                 
DWORD r;
...
DWORD WINAPI THREATE2(void* arg){
	WaitForSingleObject(n,INFINITE);
HANDLE hFile=CreateFile(L"D:\\проги\\ урсачќ—\\ урсач\\шахматы3.txt",GENERIC_READ, FILE_SHARE_READ,NULL,OPEN_EXISTING,FILE_ATTRIBUTE_NORMAL,NULL);                 
DWORD r;
...
DWORD WINAPI THREATE3(void* arg){
	WaitForSingleObject(n,INFINITE);
HANDLE hFile=CreateFile(L"D:\\проги\\ урсачќ—\\ урсач\\шахматы4.txt",GENERIC_READ, FILE_SHARE_READ,NULL,OPEN_EXISTING,FILE_ATTRIBUTE_NORMAL,NULL);                 
DWORD r;
